...
from app.core.enums import OrderEnum, SearchFieldOperatorEnum
...
class SelectListOptionResponseSchema(BaseModel):
    key: typing.Optional[UUID4] = Field(title="Key")
    label: str = Field(title="Label")
    value: typing.Optional[UUID4] = Field(title="Value")
